...
def autoencoder():
    ...
    function_name = "d2m_group_shifted_m_rotated_ackely"
    fcn_num = 11  # Assuming the function number is its position in the list
    lb = -32
    ub = 32
    ...
    FILENAME = "d2m_group_shifted_m_rotated_ackely.csv"
